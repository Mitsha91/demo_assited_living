...
/* -- 20200205 [ME]: Funcion para traer los iconos en vector (formato svg) -- */
//require_once get_stylesheet_directory() . '/icons-svg.php';
include('icons-svg.php');

	//bootstrap
	/*function bootstrap_css()
	{
		wp_enqueue_style('bootstrap_css', get_stylesheet_directory_uri() . '/style_bootstrap/bootstrap.min.css', array(),'5.2.0');
	}
	add_action( 'wp_enqueue_scripts', 'bootstrap_css' );*/
	
	/*function bootstrap_js()
	{
		wp_enqueue_script('bootstrap_js', get_stylesheet_directory_uri() . '/js_b5/bootstrap.min.js', array(jquery),'5.2.0',true);
	}
